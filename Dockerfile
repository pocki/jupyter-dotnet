#build with: docker build --build-arg base_image=jupyter/minimal-notebook -t pocki/minimal-dotnet .
#build with: docker build --build-arg base_image=jupyter/scipy-notebook -t pocki/scipy-dotnet .
#build with: docker build --build-arg base_image=jupyter/r-notebook -t pocki/r-dotnet .
